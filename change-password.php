...
else
{
    if(isset($_POST['submit']))
    {
        ...
        $sql=mysqli_query($con,"SELECT password FROM  users where username='$adminid'");
...
<html lang="en">
    <head>
        <title>NewsBuzz | Add Category</title>
        <!-- App css -->
    ...
    <body class="fixed-left"> <!-- Begin page -->
        <div id="wrapper">
<!-- Top Bar Start --> <?php include('includes/includes/topheader.php');?> <!-- Top Bar End -->
<!-- ========== Left Sidebar Start ========== --> <?php include('includes/includes/leftsidebar.php');?> <!-- Left Sidebar End -->
