    ...
    <!--- Sidemenu -->
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Source </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="add-source.php">Add Source</a></li>
                        <li><a href="manage-source.php">Manage Source</a></li>
                    </ul>
                </li>

                <!-- <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Domain </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                            <li><a href="add-domain.php">Add Domain</a></li>
                            <li><a href="manage-domain.php">Manage Domain</a></li>
                        </ul>
                </li> -->
