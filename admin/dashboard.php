        ...
        <div id="wrapper">
            <div class="topbar"> <!-- Top Bar Start -->
                <div class="topbar-left"> <!-- LOGO -->
                    <a href="index.html" class="logo"><span>NewsBuzz<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                </div>
                <!-- Button mobile view to collapse sidebar menu -->
            <?php include('includes/topheader.php');?>
            </div>
            <!-- Top Bar End -->
<!-- ========== Left Sidebar Start ========== --> <?php include('includes/leftsidebar.php');?> <!-- Left Sidebar End -->
<!-- ============================================================== -->
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <a href="manage-source.php"> 
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">News Source</p>
                                            <?php $query=mysqli_query($con,"select * from tblsource where Is_Active=1");
                                            $countposts=mysqli_num_rows($query); ?>
                                            <h2><?php echo htmlentities($countposts);?> <small></small></h2>
                                        </div>
                                    </div>
                                ...
                                <!-- <a href="manage-domain.php"> 
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">News Domain</p>
                                            <?php //$query=mysqli_query($con,"select * from domain where Is_Active=1");
                                            //$countposts=mysqli_num_rows($query); ?>
                                            <h2><?php //echo htmlentities($countposts);?> <small></small></h2>
                                        </div>
                                    </div>
